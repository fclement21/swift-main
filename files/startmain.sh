...
if [ ! -e /etc/swift/account.builder ]; then
	...
	swift-ring-builder object.builder add r1z1-127.0.0.1:6010R${replication}:6010/sdb1 1
	swift-ring-builder object.builder rebalance
	swift-ring-builder container.builder create ${SWIFT_PART_POWER} 1 ${SWIFT_PART_HOURS}
	swift-ring-builder container.builder add r1z1-127.0.0.1:6011R${replication}:6011/sdb1 1
	swift-ring-builder container.builder rebalance
	swift-ring-builder account.builder create ${SWIFT_PART_POWER} 1 ${SWIFT_PART_HOURS}
	swift-ring-builder account.builder add r1z1-127.0.0.1:6012R${replication}:6012/sdb1 1
